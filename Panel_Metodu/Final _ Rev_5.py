# -*- coding: utf-8 -*-
"""
Reference from https://lorenabarba.com/blog/announcing-aeropython/

Created on Thu Jan  9 15:42:31 2020
...
naca_filepath = os.path.join('naca_profilleri', 'naca6409.dat.txt')
...
class Panel:
    ...
    def __init__(self, xa, ya, xb, yb): #Panel yapısı ile ilgili
        ...
        Panelin uç noktalarını,merkez noktalarını uzunluğunu ve x ekseni ile
...
# Sirkülasyon yoğunluğunun biriktirme
gamma = strengths[-1]
